    ...
    CoreModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            providers: [
                ...
                { provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HTTP_INTERCEPTORS"], useClass: _shared_auth_interceptor__WEBPACK_IMPORTED_MODULE_10__["AuthInterceptor"], multi: true },
                { provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HTTP_INTERCEPTORS"], useClass: _shared_logging_interceptor__WEBPACK_IMPORTED_MODULE_11__["LoggingInterceptor"], multi: true }
            ]
        })
    ], CoreModule);
    return CoreModule;
...
var DataStorageService = /** @class */ (function () {
    function DataStorageService(httpClient, recipeService, shoppingListService, authService) {
    ...
    DataStorageService.prototype.storeRecipes = function () {
        ...
        // return this.httpClient.put('https://recipe-book-29d2c.firebaseio.com/recipes.json', this.recipeService.getRecipes(), {
        //   observe: 'body',
        //   params: new HttpParams().set('auth', token)
        //   // headers: headers
        // });
        var req = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpRequest"]('PUT', 'https://recipe-book-29d2c.firebaseio.com/recipes.json', this.recipeService.getRecipes(), { reportProgress: true });
        return this.httpClient.request(req);
    };
    DataStorageService.prototype.storeShoppingList = function () {
        var req = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpRequest"]('PUT', 'https://recipe-book-29d2c.firebaseio.com/shopping-list.json', this.shoppingListService.getIngredients(), { reportProgress: true });
        return this.httpClient.request(req);
    };
    DataStorageService.prototype.getRecipes = function () {
        var _this = this;
        // this.httpClient.get<Recipe[]>('https://recipe-book-29d2c.firebaseio.com/recipes.json?auth=' + token)
        this.httpClient.get('https://recipe-book-29d2c.firebaseio.com/recipes.json', {
            observe: 'body',
            responseType: 'json'
        })
    ...
    DataStorageService.prototype.getShoppingList = function () {
        var _this = this;
        this.httpClient.get('https://recipe-book-29d2c.firebaseio.com/shopping-list.json', {
            observe: 'body',
            responseType: 'json'
        })
...
module.exports = __webpack_require__(/*! D:\Udemy\Hamburger_App_Angular\src\main.ts */"./src/main.ts");
